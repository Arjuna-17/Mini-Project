...
{
	int n_x[8], n_y[8];
	n_x[0] = pos_x-1; n_x[1] = pos_x-1; n_x[2] = pos_x-1; n_x[3] = pos_x;
	n_x[4] = pos_x+1; n_x[5] = pos_x+1; n_x[6] = pos_x+1; n_x[7] = pos_x;

	n_y[0] = pos_y-1; n_y[1] = pos_y; n_y[2] = pos_y+1; n_y[3] = pos_y+1;
	n_y[4] = pos_y+1; n_y[5] = pos_y; n_y[6] = pos_y-1; n_y[7] = pos_y-1;
